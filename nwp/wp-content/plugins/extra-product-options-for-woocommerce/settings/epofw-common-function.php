 ...
 * Field data.
 *
 * @param array $field_property_array Property of array.
 *
 ...
 * @param string $inc_key     Field key.
 *
 * @since 1.0.0
 */
 ...
 * @since 1.0.0
 */
function cp_render_fields_front( $attr_data, $field_type, $product_data ) {
	$html = '';
	switch ( $field_type ) {
		case 'text':
		case 'password':
 ...
 * @param int|float $price Addon price.
 *
 * @return string
 */
 ...
 * @param string $inc_key     Key of the field.
 *
 * @since 1.0.0
 */
 ...
 * Get data for fields.
 *
 * @param int $get_post_id Get post id.
 *
 ...
 * @param string $gn_key         Key of the field.
 *
 ...
 *
 * @param string $string Get Name of the field.
 *
 * @return mixed
 *
 * @since 1.8.8
...
/**
 * Display product price based on tax.
 *
