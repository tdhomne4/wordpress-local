...
if ( ! class_exists( 'EPOFW_MAIN' ) ) {
	...
	class EPOFW_MAIN {
		 ...
		 *
		 * @since    1.0.0
		 * @var      string $epofw_main_instance Object of the class.
		 */
		protected static $epofw_main_instance = null;
		/**
		 * Get current page.
		 *
		...
		public static function instance() {
			if ( is_null( self::$epofw_main_instance ) ) {
				self::$epofw_main_instance = new self();
			}
			return self::$epofw_main_instance;
		}
		/**
		 * Constructor.
		 *
