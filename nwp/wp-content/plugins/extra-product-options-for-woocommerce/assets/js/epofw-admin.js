( function ( $ ) {
	...
	var AWS_ADMIN = {
		init: function () {
			...
			jQuery( document ).on( 'change', '#enable_price_extra input[type="checkbox"]', AWS_ADMIN.enablePrice );
			jQuery( document ).on( 'change', '#enable_title_extra input[type="checkbox"]', AWS_ADMIN.enableTitleExtra );
			jQuery( document ).on( 'change', '#enable_subtitle_extra input[type="checkbox"]', AWS_ADMIN.enableSubTitleExtra );
		...
		disableAllOptions: function () {
			var fieldIds = [];
			jQuery( '.accordion_cls' ).each( function () {
